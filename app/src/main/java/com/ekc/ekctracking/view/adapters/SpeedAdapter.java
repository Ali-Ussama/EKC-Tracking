...
public class SpeedAdapter extends RecyclerView.Adapter<SpeedAdapter.viewHolder> {
    ...
    public void onBindViewHolder(@NonNull viewHolder holder, int position) {
        if (data.get(position).getSpeed2().equals(selectedSpeed) && position == selectedPosition) {
            Log.d(TAG, "onBindViewHolder: position = " + position + " selected");
            ...
            Log.d(TAG, "onBindViewHolder: position = " + position + " not selected");
        ...
        Log.d(TAG, "onBindViewHolder: speed = " + data.get(position));
    }
